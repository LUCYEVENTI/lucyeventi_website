            ...
            <div className="container">
                ...
                >
                    <Card variants={itemVariants} className="tech-card">
                        <ParticleImage src="assets/icon-ai-matching.png" alt="AI Matching" delay={0.2} size={120} />
                    ...
                    <Card variants={itemVariants} className="tech-card">
                        <ParticleImage src="assets/icon-analytics.png" alt="Analytics" delay={0.4} size={120} />
                    ...
                    <Card variants={itemVariants} className="tech-card">
                        <ParticleImage src="assets/icon-cloud.png" alt="Cloud" delay={0.6} size={120} />
